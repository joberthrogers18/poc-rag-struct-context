...
def get_indexed_file_hash(conn, repo_name: str, team_name: str, rel_path: str) -> str | None:
...
def mark_file_deleted(conn, repo_name: str, team_name: str, rel_path: str, source_type: str):
